                ...
                if handle and handle.url_tmpl then
                    ...
                    if to_redirect and to_redirect ~= ngx_var_uri then
                        ...
                        if handle.log == true then
                            require("orange.utils.logutils").log(ngx.INFO, "[Redirect] ", ngx_var_uri, " to:", to_redirect)
                        end
...
function RedirectHandler:redirect()
    ...
    for i, sid in ipairs(ordered_selectors) do
        require("orange.utils.logutils").log(ngx.INFO, "==[Redirect][PASS THROUGH SELECTOR:", sid, "]")
        ...
        if selector and selector.enable == true then
            ...
            if selector_pass then
                if selector.handle and selector.handle.log == true then
                    require("orange.utils.logutils").log(ngx.INFO, "[Redirect][PASS-SELECTOR:", sid, "] ", ngx_var_uri)
                end
                ...
                if selector.handle and selector.handle.log == true then
                    require("orange.utils.logutils").log(ngx.INFO, "[Redirect][NOT-PASS-SELECTOR:", sid, "] ", ngx_var_uri)
                end
            end
        end
    end
