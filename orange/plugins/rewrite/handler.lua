                ...
                if handle and handle.uri_tmpl then
                    ...
                    if to_rewrite and to_rewrite ~= ngx_var_uri then
                        if handle.log == true then
                            require("orange.utils.logutils").log(ngx.INFO, "[Rewrite] ", ngx_var_uri, " to:", to_rewrite)
                        end
...
function RewriteHandler:rewrite(conf)
    ...
    for i, sid in ipairs(ordered_selectors) do
        require("orange.utils.logutils").log(ngx.INFO, "==[Rewrite][PASS THROUGH SELECTOR:", sid, "]")
        ...
        if selector and selector.enable == true then
            ...
            if selector_pass then
                if selector.handle and selector.handle.log == true then
                    require("orange.utils.logutils").log(ngx.INFO, "[Rewrite][PASS-SELECTOR:", sid, "] ", ngx_var_uri)
                end
                ...
                if selector.handle and selector.handle.log == true then
                    require("orange.utils.logutils").log(ngx.INFO, "[Rewrite][NOT-PASS-SELECTOR:", sid, "] ", ngx_var_uri)
                end
            end
        end
    end
